import brandingHeroImage from "../../imports/optimized/japanese-woman-in-office-portrait-2026-03-09-05-22-48-utc.jpg";
...
const pageSchema = {
  ...
  "description": "Personal branding photography for entrepreneurs, coaches and business owners in Dubai and the UAE. Indicative packages from AED 1,500.",
...
const faqs = [
  ...
  { q: "How quickly will I receive my images?", a: "Draft structure: standard turnaround is 10-14 days. Executive packages include priority turnaround of 5-7 days. Rush delivery can be arranged for an additional fee." },
];

const packages = [
  { name: "Starter", price: "Indicative AED 1,500", details: ["1 hour", "1 outfit", "1 location", "20+ edited images", "Full commercial licence", "Online gallery"], note: "For: Freelancers and early-stage professionals", featured: false },
  { name: "Professional", price: "Indicative AED 2,200", details: ["2 hours", "2 outfits", "1 location", "40+ edited images", "Styling guidance included", "Full commercial licence", "Online gallery"], note: "For: Coaches, consultants, business owners", featured: true },
  { name: "Executive", price: "Indicative AED 3,800", details: ["Half day", "4 outfits", "2 locations", "80+ edited images", "Priority turnaround (5-7 days)", "Social media crop set included", "Full commercial licence"], note: "For: Senior professionals, speakers, C-suite", featured: false },
];

const industries = ["Consulting", "Real Estate", "Legal", "Finance", "Healthcare & Wellness", "Coaching", "Technology", "Hospitality"];

const testimonials = [
  { name: "Sample brand client", role: "Draft testimonial - Dubai", text: "My brand presence changed overnight. Clients now comment on my photos before anything else. The enquiry rate from LinkedIn doubled within a month." },
  { name: "Sample brand client", role: "Draft testimonial - Abu Dhabi", text: "I'd been putting it off for two years. Thirty minutes into the session I understood why I should have done it years ago. Emily made it effortless." },
  { name: "Sample brand client", role: "Draft testimonial - Dubai", text: "The investment paid for itself quickly. Two clients mentioned my photograph as the reason they reached out. That doesn't happen with a selfie." },
];
...
export default function PersonalBranding() {
  return (
    <>
      <SEO
        title="Personal Branding Photographer Dubai | Professional Headshots UAE | EHRay"
        description="Personal branding photographer in Dubai for entrepreneurs, coaches and business owners. Professional imagery that builds trust. Indicative packages from AED 1,500."
      ...
      <section className="relative h-[85vh] min-h-[580px] overflow-hidden bg-muted pt-[72px]">
        <img src={brandingHeroImage} alt="Professional woman portrait in office - EHRay Personal Branding Photography UAE" className="absolute inset-0 w-full h-full object-cover object-[center_35%]" />
        <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent" />
        <div className="relative z-10 h-full flex items-end pb-16 max-w-7xl mx-auto px-6 w-full">
          <div>
            <p className="text-white/50 text-[10px] tracking-[0.35em] uppercase mb-5 font-medium">EHRay Photography &nbsp;·&nbsp; Personal Branding</p>
      ...
      <section className="py-24 bg-background">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-5">
            {[
              { stat: "0.1 seconds", body: "Draft proof point: the time it takes someone to form a first impression. Your photograph is often the first impression." },
              { stat: "14x more views", body: "Draft proof point: LinkedIn profiles with professional photographs receive significantly more profile views than those without." },
              { stat: "Trust", body: "Clients choose people, not just services. Authentic images make that choice easier." },
            ].map(s => (
      ...
      <section className="py-24 bg-background">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <p className="text-muted-foreground text-[15px] mb-14 max-w-xl">Indicative package structure for client review. Final pricing, usage rights and deliverables should be confirmed by EHRay before launch.</p>
          <div className="grid md:grid-cols-3 gap-5">
            {packages.map(pkg => (
      ...
      <section className="py-24 bg-background">
        <div className="max-w-7xl mx-auto px-6">
          <p className="text-muted-foreground text-[10px] tracking-[0.35em] uppercase mb-4 font-medium">Sample Client Results</p>
          <h2 className="text-3xl sm:text-4xl font-medium text-foreground mb-4" style={{ fontFamily: "'Lora', Georgia, serif" }}>What could change for them.</h2>
          <p className="text-muted-foreground text-sm mb-14 max-w-xl leading-relaxed">Draft testimonial examples for client review. Replace with verified personal-branding results before launch.</p>
          <div className="grid md:grid-cols-3 gap-5">
      ...
      <div id="contact">
        <BookingCTA headline="Start with a conversation." subtext="A free discovery call to understand your brand, your goals and what the right session looks like for you." sessionType="Personal Branding" />
      </div>
    </>
  );
}
